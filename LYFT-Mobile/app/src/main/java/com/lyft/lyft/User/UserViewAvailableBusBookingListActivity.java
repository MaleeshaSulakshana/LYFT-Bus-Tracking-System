...
import com.lyft.lyft.Driver.DriverViewAvailableBookingListActivity;
...
public class UserViewAvailableBusBookingListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_view_available_bus_booking_list);
        ...
        litView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int i, long id) {
                ...
                Intent intent = new Intent(UserViewAvailableBusBookingListActivity.this, UserViewAvailableBusBookingDetailsActivity.class);
    ...
    private void showListData()
    {
        ...
        try {
            String URL = API.BOOKING_AVAILABLE_API + "date";

            RequestQueue requestQueue = Volley.newRequestQueue(UserViewAvailableBusBookingListActivity.this);
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    Toast.makeText(UserViewAvailableBusBookingListActivity.this, "Some error occur" + error.toString(), Toast.LENGTH_SHORT).show();
                }
            }) {
                @Override
